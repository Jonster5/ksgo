...
Pebble.NeuralNetwork = class {
    ...
    static deserialize(data) {
        ...
        let nn = new Pebble.NeuralNetwork(data.input_nodes, data.hidden_nodes, data.output_nodes);
        nn.weights_ih = Pebble.Matrix.deserialize(data.weights_ih);
        nn.weights_ho = Pebble.Matrix.deserialize(data.weights_ho);
        nn.bias_h = Pebble.Matrix.deserialize(data.bias_h);
        nn.bias_o = Pebble.Matrix.deserialize(data.bias_o);
    ...
    copy() {
        return new Pebble.NeuralNetwork(this);
    }
